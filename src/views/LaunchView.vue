<template>
  <BaseLayout>
    <div class="flex justify-between flex-wrap mb-14 xl:mb-20 gap-y-10">
      <div>
    ...
    <div class="grid grid-cols-1 gap-y-8 md:grid-cols-2 xl:grid-cols-3 gap-x-8 xl:gap-y-12">
      ...
      <div class="card card-border bg-base-100 w-full md:col-span-2 min-h-56">
